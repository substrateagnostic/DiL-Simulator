...
export const DIALOGS = {
  ...
  receptionist_intro: [
    ...
    { type: 'text', speaker: 'Diane (Front Desk)', text: "Oh, and keep your badge visible at all times. Skip gets... particular about that." },
  ...
  neutral_npc: [
    /* 0 */ { type: 'text', speaker: 'Narrator', text: "They give you the nod of someone saving their conversation for a better fiscal quarter." },
    /* 1 */ { type: 'end' },
  ],
  ...
  neutral_isaiah: [
    /* 0 */ { type: 'text', speaker: 'Isaiah', text: "Files come in, files go out. It steadies a person, if you let it." },
    /* 1 */ { type: 'end' },
  ],

  neutral_diane: [
    /* 0 */ { type: 'text', speaker: 'Diane', text: "Quiet at the front desk just now. I've been here long enough not to say that out loud." },
    /* 1 */ { type: 'end' },
  ],
  ...
  janet_intro: [
    ...
    /* 10 */ { type: 'text', speaker: 'Janet', text: "Number three: Skip will use the word 'synergy' at least fourteen times before lunch. Don't drink every time or you'll end up like me." },
    ...
    /* 13 */ { type: 'text', speaker: 'Janet', text: "Let's see... Skip is your boss. He's... enthusiastic. He once described a simple trust amendment as 'a paradigm-shifting leverage event.'" },
  ...
  // --------------------------------------------------------------------------
  alex_it_intro: [
    /* 0  */ { type: 'text', speaker: 'Alex from IT', text: "Andrew, right? I knew at 8:52 — the badge server and I keep each other informed. Welcome to Vaults Fargo." },
    ...
    /* 11 */ { type: 'text', speaker: 'Alex from IT', text: 'The server room. Everything in this building is connected, and the server room is where it admits it.' },
    ...
    /* 15 */ { type: 'text', speaker: 'Alex from IT', text: "I haven't blocked it. You don't block a thing like that. You watch it, and you let it think it's alone.", next: 6 },
  ...
  intern_intro: [
    ...
    /* 9  */ { type: 'text', speaker: 'The Intern', text: "Skip said to 'make the Henderson pre-audit documents disappear.' I assumed he meant magically but the budget didn't cover a magician so..." },
  ...
  ross_not_ready: [
    ...
    /* 3 */ { type: 'text', speaker: 'Skip Hartley', text: "Go say hi to all four of them. Then come back and we'll talk Henderson. Big things, buddy. Big things. *finger guns*" },
    /* 4 */ { type: 'end' },
  ],
  ...
  ross_intro: [
    ...
    /* 3  */ { type: 'text', speaker: 'Skip Hartley', text: "The specifics aren't important. What's important is the ENERGY. And the energy here is: Henderson family, big trust, lots of assets." },
    /* 4  */ { type: 'text', speaker: 'Skip Hartley', text: "Mrs. Henderson's assets are... substantial. Very well-endowed. The trust, I mean. The trust is well-endowed." },
    /* 5  */ { type: 'text', speaker: 'Skip Hartley', text: 'We need to handle those assets with extreme care. Really get in there and... manage them. Thoroughly.' },
    /* 6  */ { type: 'text', speaker: 'Andrew', text: 'Can we maybe just talk about the actual case?' },
    /* 7  */ { type: 'text', speaker: 'Skip Hartley', text: 'Right! So. Old Man Henderson passed away last month. Left behind a trust worth about $42 million.' },
    ...
    /* 12 */ { type: 'text', speaker: 'Skip Hartley', text: 'Fiduciary obligation? Great question. Love the initiative. Very on-brand.' },
    /* 13 */ { type: 'text', speaker: 'Skip Hartley', text: 'Our fiduciary obligation is to... leverage our core competencies to maximize stakeholder value while maintaining regulatory alignment across all verticals.' },
    /* 14 */ { type: 'text', speaker: 'Andrew', text: "That didn't answer my question at all.", next: 11 },
    /* 15 */ { type: 'text', speaker: 'Skip Hartley', text: 'Disaster? No no no. This is an OPPORTUNITY. Every trust dispute is a chance to demonstrate our value proposition.' },
    /* 16 */ { type: 'text', speaker: 'Skip Hartley', text: "Plus, the fee structure on a disputed $42 million trust? *chef's kiss* That's quarterly bonus territory, my friend." },
    /* 17 */ { type: 'text', speaker: 'Skip Hartley', text: "Just remember: we need to penetrate the Henderson account from multiple angles. Get deep into those assets. Really feel them out.", next: 11 },
  ...
  diane_intro: [
    ...
    /* 2  */ { type: 'text', speaker: 'Diane', text: "How does it work? It doesn't. It continues. There's a difference, and the difference is me." },
    /* 3  */ { type: 'text', speaker: 'Diane', text: "Skip makes decisions based on whatever business book he read that morning. The Intern executes those decisions incorrectly. Janet handles the fallout. I document everything." },
    ...
    /* 5  */ { type: 'text', speaker: 'Diane', text: "My advice? Keep your head down, document EVERYTHING, and never CC Skip on an email unless you want a 45-minute reply about 'synergistic client engagement strategies.'" },
  ...
  chad_meeting: [
    ...
    /* 15 */ { type: 'text', speaker: 'Andrew', text: 'That is, and I want to be precise about this, the worst investment plan I have ever heard.' },
  ...
  ross_act2: [
    ...
    /* 2  */ { type: 'text', speaker: 'Skip Hartley', text: "Disaster? No, no, no. Reframe. It's a... disruption event. We're being disrupted. By the client. In the client-facing space." },
    /* 3  */ { type: 'text', speaker: 'Skip Hartley', text: "This is actually GREAT. Know why? Because disruption is where INNOVATION happens." },
    /* 4  */ { type: 'text', speaker: 'Andrew', text: 'Karen threw a binder at me.' },
    /* 5  */ { type: 'text', speaker: 'Skip Hartley', text: "Physical engagement! That's high-touch client interaction, baby! Write that in the quarterly report!" },
    /* 6  */ { type: 'text', speaker: 'Skip Hartley', text: "Okay, okay, okay. So here's what I'm thinking. And this is blue-sky, right? Real outside-the-box stuff." },
    /* 7  */ { type: 'text', speaker: 'Skip Hartley', text: "What if -- and stay with me here -- what if we just... give everyone what they want?" },
    /* 8  */ { type: 'text', speaker: 'Andrew', text: "The assets total $42 million. They're each asking for about $40 million." },
    /* 9  */ { type: 'text', speaker: 'Skip Hartley', text: "Right. So we need... *counting on fingers* ...about $80 million more. Can we leverage something?" },
    /* 10 */ { type: 'text', speaker: 'Andrew', text: 'Leverage WHAT, Skip?' },
    /* 11 */ { type: 'text', speaker: 'Skip Hartley', text: "I don't know, that's a details question. I'm a big-picture guy. Details are for people who haven't achieved executive consciousness yet." },
    /* 12 */ { type: 'text', speaker: 'Skip Hartley', text: "Look, here's my advice: penetrate the Henderson situation from a position of strength. Really drill down into those assets. Get your hands on the principal and don't let go." },
    /* 13 */ { type: 'text', speaker: 'Andrew', text: 'You know those all sound like innuendos, right?' },
    /* 14 */ { type: 'text', speaker: 'Skip Hartley', text: "Innuendo? That's an Italian word. See? This is global thinking. We're going global with this, Andrew." },
    /* 15 */ { type: 'text', speaker: 'Skip Hartley', text: "Okay, I gotta run. I have a leadership webinar on 'Synergistic Disruption in the Post-Trust Era.' It's an hour long but I'm only going for the free tote bag." },
    /* 16 */ { type: 'text', speaker: 'Skip Hartley', text: 'Keep crushing it! *finger guns*' },
    /* 17 */ { type: 'end' },
  ],
  ...
  ross_post_karen: [
    ...
    /* 3  */ { type: 'text', speaker: 'Skip Hartley', text: "And you SURVIVED. That's the narrative. You're a survivor. This is a brand moment, Andrew. We should get you a mug." },
    /* 4  */ { type: 'text', speaker: 'Skip Hartley', text: "Okay. Next up: Chad. Chad Henderson. Chad is... different." },
    /* 5  */ { type: 'text', speaker: 'Skip Hartley', text: "Karen had rage. Organized, tabulated, binder-formatted rage. Chad has... energy. Undirected energy. The kinetic chaos of a man who once tried to invest his entire trust distribution in a cryptocurrency called PumpCoin." },
    ...
    /* 10 */ { type: 'text', speaker: 'Skip Hartley', text: "THAT is the spirit. Adaptability. That's going in your performance review right now. Mentally. In my head." },
  ...
  janet_act2: [
    ...
    /* 8  */ { type: 'text', speaker: 'Janet', text: 'Also -- and this is the REAL gossip -- I was in the copy room and I overheard Skip on the phone.' },
    ...
    /* 11 */ { type: 'text', speaker: 'Janet', text: "Make of that what you will. I've made of it something I keep in the locked drawer." },
  ...
  // --------------------------------------------------------------------------
  alex_it_act2: [
    /* 0  */ { type: 'text', speaker: 'Alex from IT', text: "Andrew. Close the door. I'm about to be very calm at you, which is how you'll know it's serious." },
    ...
    /* 7  */ { type: 'text', speaker: 'Alex from IT', text: "The access logs are clean. Which is itself a finding -- nobody's logs are clean. Mine aren't clean, and I'm the one who reads them." },
  ...
  branch_decision: [
    ...
    /* 8  */ { type: 'text', speaker: 'Andrew', text: "Skip, the trust language favors the surviving spouse. Karen and Chad will need to accept a smaller distribution. That's the law." },
    /* 9  */ { type: 'text', speaker: 'Skip Hartley', text: "The LAW? Andrew, the law is... look, the law is like a speed limit. It's more of a suggestion." },
    /* 10 */ { type: 'text', speaker: 'Andrew', text: "It's really not." },
    /* 11 */ { type: 'text', speaker: 'Skip Hartley', text: "Fine. FINE. But when Karen calls corporate -- and she WILL call corporate -- you're taking that meeting. Not me. I'll be at my leadership webinar. The one about disruption. *click*", next: 27 },
    /* 12 */ { type: 'text', speaker: 'Narrator', text: 'You choose the creative path. Rules were made to be... interpreted flexibly.' },
    /* 13 */ { type: 'text', speaker: 'Andrew', text: "Skip, I think we can restructure the distribution to give everyone something. It'll take some creative accounting and maybe bending a few guidelines." },
    /* 14 */ { type: 'text', speaker: 'Skip Hartley', text: "Now THAT'S what I'm talking about! Innovation! Disruption! I knew I hired you for a reason!" },
    /* 15 */ { type: 'text', speaker: 'Skip Hartley', text: "Wait, I didn't hire you. HR did. But I'm going to take credit for it." },
    /* 16 */ { type: 'text', speaker: 'Skip Hartley', text: "Do what you gotta do, buddy. I'll make sure compliance is looking the other way. I have dirt on the compliance guy. Long story. *click*", next: 27 },
    /* 17 */ { type: 'text', speaker: 'Narrator', text: "You choose Grandma's path. Page 47, paragraph 3. The clause nobody reads." },
    /* 18 */ { type: 'text', speaker: 'Andrew', text: "Skip, I've been looking at the trust document. There's a clause on page 47 that changes everything. I think Grandma Henderson has been playing us all." },
    /* 19 */ { type: 'text', speaker: 'Skip Hartley', text: "Page 47? Nobody reads that far. That's like the terms of service of a trust document." },
    /* 20 */ { type: 'text', speaker: 'Andrew', text: 'Skip... did you know that Grandma Henderson used to work here? In trust administration?' },
    /* 21 */ { type: 'text', speaker: 'Narrator', text: 'There is a very long pause on the phone.' },
    /* 22 */ { type: 'text', speaker: 'Skip Hartley', text: '...How did you find that out?' },
    /* 23 */ { type: 'text', speaker: 'Andrew', text: "Skip, is there something you're not telling me?" },
  ...
  bro_code_ending: [
    ...
    /* 8  */ { type: 'text', speaker: 'Andrew', text: 'Look, Skip said it was--' },
    /* 9  */ { type: 'text', speaker: 'Compliance Auditor', text: "Skip. Yes. Skip told you to 'make it work.' Skip also once approved a loan application written in crayon because the applicant 'had good energy.'" },
    /* 10 */ { type: 'text', speaker: 'Compliance Auditor', text: 'Skip is not a reliable source of compliance guidance. Skip is barely a reliable source of oxygen.' },
  ...
  secret_ending: [
    ...
    /* 7  */ { type: 'text', speaker: 'Skip Hartley', text: "ADOPTIVE mother. Technically. Harold Henderson married my mom when I was ten. It's... complicated. Like all trust structures. Heh." },
    ...
    /* 20 */ { type: 'text', speaker: 'Narrator', text: 'You and Skip look at each other.' },
    /* 21 */ { type: 'text', speaker: 'Skip Hartley', text: 'What?! Mom, I would NEVER--' },
    /* 22 */ { type: 'text', speaker: 'Grandma Henderson', text: "Of course not, Skip. You can barely operate the coffee machine. You think I'd suspect you of sophisticated financial fraud?" },
    ...
    /* 25 */ { type: 'text', speaker: 'Grandma Henderson', text: "But Skip told me about you, Andrew. How you actually read the trust documents. How you didn't cry when Karen threw the binder. How you chose to look at page 47." },
    ...
    /* 27 */ { type: 'text', speaker: 'Skip Hartley', text: 'Mom, this is a lot. Can we circle back on--' },
    /* 28 */ { type: 'text', speaker: 'Grandma Henderson', text: "Skip. If you say 'circle back' one more time, I will change the trust to leave everything to the cat." },
    /* 29 */ { type: 'text', speaker: 'Skip Hartley', text: "...We don't have a cat." },
  ...
  karen_first_loss_tutorial: [
    ...
    /* 1 */ { type: 'text', speaker: 'Skip Hartley', text: "Hey. Hey! You okay? What happened in there?" },
    /* 2 */ { type: 'text', speaker: 'Andrew', text: "She had a binder." },
    /* 3 */ { type: 'text', speaker: 'Skip Hartley', text: "Yeah, she always has the binder. Listen — Karen's been doing this for years. She knows every loophole, every pressure point, every trick." },
    /* 4 */ { type: 'text', speaker: 'Skip Hartley', text: "You can't walk in there at your current level and expect to hold your ground. You need more experience. More Assertiveness. More Composure." },
    /* 5 */ { type: 'text', speaker: 'Andrew', text: "How do I get that?" },
    /* 6 */ { type: 'text', speaker: 'Skip Hartley', text: "The reception desk. Prospective clients come in all day. Handle their cases, win the fights, build up your skills." },
    ...
    /* 14 */ { type: 'text', speaker: 'Skip Hartley', text: "And Grandma... don't underestimate her. She ran this office for twenty years. Sweet talk won't work — she invented sweet talk. But she's never had her own books audited. An audit approach will catch her off guard." },
    /* 15 */ { type: 'text', speaker: 'Andrew', text: "...She's coming back, isn't she." },
    /* 16 */ { type: 'text', speaker: 'Skip Hartley', text: "She never left. She's in the conference room right now writing a Yelp review about the parking situation." },
    /* 17 */ { type: 'end' },
  ],
  ...
  intern_retry: [
    { type: 'text', speaker: 'The Intern', text: "Oh no. I mean — oh, hey! You're back. I Googled some new techniques. I'm so sorry in advance." },
  ...
  alex_it_return: [
    /* 0 */ { type: 'text', speaker: 'Alex from IT', text: "Can't talk. Running a packet trace. Also your printer is still possessed — that's not a ticket, that's a relationship." },
    /* 1 */ { type: 'end' },
  ],

  intern_return: [
    /* 0 */ { type: 'text', speaker: 'The Intern', text: 'Hey Aiden! I mean -- whatever your name is!' },
    /* 1 */ { type: 'text', speaker: 'The Intern', text: "I would talk more but Skip has me reorganizing the filing cabinets by 'vibrational frequency.' I don't know what that means and I'm afraid to ask." },
    /* 2 */ { type: 'end' },
  ],
  ...
  janitor_return: [
    ...
    /* 6 */ { type: 'text', speaker: 'Mysterious Janitor', text: "You're still standing. The building notices things like that." },
  ...
  ross_post_chad: [
    ...
    /* 3  */ { type: 'text', speaker: 'Skip Hartley', text: "I had a senior consultant go in there in 2019. He came out speaking only in passive-aggressive non-answers. He's currently our VP of Compliance." },
    /* 4  */ { type: 'text', speaker: 'Andrew', text: "What does she actually want?" },
    /* 5  */ { type: 'text', speaker: 'Skip Hartley', text: "Everything. In writing. Notarized. With a follow-up call. She will offer you a cookie. Do NOT comment on the cookie." },
    /* 6  */ { type: 'text', speaker: 'Andrew', text: "What's wrong with the cookie?" },
    /* 7  */ { type: 'text', speaker: 'Skip Hartley', text: "Nobody knows. Three people have asked. They all transferred to the Omaha office voluntarily. On the same day. We don't talk about it." },
    /* 8  */ { type: 'text', speaker: 'Skip Hartley', text: "Your only move is to stay calm, keep your documentation airtight, and under no circumstances let her redirect you with a story about her late husband Gerald." },
    /* 9  */ { type: 'text', speaker: 'Andrew', text: "Was Gerald—" },
    /* 10 */ { type: 'text', speaker: 'Skip Hartley', text: "She will redirect you with a story about Gerald. Just nod. Set a mental timer for four minutes. After four minutes it loops back around to the trust. That's your window.", next: 16 },
  ...
  compliance_defeated: [
    ...
    // `compliance_defeated && !compliance_crossword_done` — they are the only
    // source of the Archive password — so walking them out of the building here
    // put them back at (13,6) on the next room entry. "Walks away" is now a
    // walk to the north end of the floor, still in the room, still findable.
    /* 13 */ { type: 'stage', next: 4, beats: [
      { actor: 'compliance', walkTo: 'board_door', face: 'player', speed: 1.7, hold: 0.3 },
  ...
  ross_boss_defeated: [
    ...
    /* 3  */ { type: 'text', speaker: 'Skip Hartley', text: "I know. I know. I'm... I'm sorry, man. I think I had a corporate break." },
    /* 4  */ { type: 'text', speaker: 'Grandma Henderson', text: 'Skip, honey, you need a vacation. And a therapist. And to stop reading leadership books.' },
  ...
  dying_plant: [
    ...
    { type: 'text', speaker: 'Narrator', text: 'A label reads: "Mr. Fernsworth III — Skip\'s Responsibility Since 2021."' },
  ...
  poster_stair_1: [
    ...
    { type: 'text', speaker: 'Andrew', text: 'I am standing on the stairs. The poster is right here. The irony is load-bearing.' },
    { type: 'end' },
  ],
  ...
  conference_whiteboard: [
    { type: 'text', speaker: 'Narrator', text: 'The whiteboard is covered in Skip\'s "strategic planning."' },
    { type: 'text', speaker: 'Narrator', text: 'It\'s a flowchart: "SYNERGY → DISRUPT → INNOVATE → LEVERAGE → SYNERGY (repeat)"' },
    { type: 'text', speaker: 'Narrator', text: 'Someone (Alex) wrote underneath: "This is just a circle." Skip responded: "Circles are the strongest shape. Like our TEAM."' },
  ...
  grandma_return: [
    /* 0 */ { type: 'text', speaker: 'Grandma Henderson', text: "Hello again, dear. I was just counting the exits. Old habit. There are four, if you count the window Skip believes is decorative." },
  ...
  intern_combat_intro: [
    ...
    { type: 'text', speaker: 'The Intern', text: 'Skip said to "make the documents disappear"! I thought he meant disappear-disappear! Like a magic trick!' },
  ...
  isaiah_intro: [
    ...
    /* 4  */ { type: 'text', speaker: 'Isaiah', text: "Skip runs the show — well, he thinks he does. Janet handles the real paperwork. The Intern... tries." },
  ...
  // Act 4+ — her cubicle is empty. The interactable lives on her monitor tile.
  rachel_note: [
  ...
  rachel_intro: [
    ...
    /* 5  */ { type: 'text', speaker: 'Meredith Sterling', text: "Mm. 'Thorough' is not a word I'd associate with Skip. Your diplomacy is noted. It will be useful." },
  ...
  alex_it_act3: [
    /* 0  */ { type: 'text', speaker: 'Alex from IT', text: "You're here. Good. Don't lock the door — locked doors get noticed. Just stand in front of it and look boring." },
    ...
    /* 7  */ { type: 'text', speaker: 'Alex from IT', text: "But the Janitor told me something, and it connects. When he was SVP, there was a server room in the basement. The Archive. It had the original trust records going back to 1947." },
    ...
    /* 10 */ { type: 'text', speaker: 'Alex from IT', text: "I know how it sounds. I said it out loud to myself first, as a test. The decryption key that was used? It's not any standard algorithm I've seen." },
    ...
    /* 13 */ { type: 'text', speaker: 'Alex from IT', text: "Either this building has an automated system nobody documented, or it has opinions. I've stopped betting against the second one." },
  ...
  ross_act3: [
    ...
    /* 6  */ { type: 'text', speaker: 'Skip Hartley', text: "Really? Because 'Lead Like a Lion, Land Like a Feather' says fear is just 'an unrealized growth metric.' But it doesn't feel like a growth metric. It feels like fear." },
    /* 7  */ { type: 'text', speaker: 'Skip Hartley', text: "Thanks, Andrew. You're... you're a good employee. And maybe also a good person. I'm realizing those might be different things." },
  ...
  intern_act3: [
    ...
    /* 1  */ { type: 'text', speaker: 'The Intern', text: "The lady from corporate — Meredith — she asked me for 'all Henderson-related documentation from the past five years.'" },
  ...
  diane_act3: [
    ...
    /* 1  */ { type: 'text', speaker: 'Diane', text: "Meredith — the SVP from corporate — she's not just doing a review. I've been watching her. She's been accessing old personnel files. Trust records from before my time." },
  ...
  rachel_act3: [
    ...
    /* 5  */ { type: 'text', speaker: 'Meredith Sterling', text: "Optimization. Modernization. Eliminating redundancies. This department has twelve people doing work that six could handle." },
    /* 6  */ { type: 'text', speaker: 'Meredith Sterling', text: "I've identified several positions for... reassignment. But someone with your results could have a future here." },
  ...
  archive_cabinets: [
    ...
    /* 9  */ { type: 'text', speaker: 'Narrator', text: "The filing cabinets have nothing further to add. They said everything between 1947 and 2016." },
  ...
  diane_act4: [
    /* 0  */ { type: 'text', speaker: 'Diane', text: "I've been documenting everything Meredith's done since she arrived. Every meeting. Every access request. Every personnel file she's reviewed." },
  ...
  intern_act4: [
    ...
    /* 1  */ { type: 'text', speaker: 'The Intern', text: "Meredith told me to clean out my desk. Which is harsh because I don't even HAVE a desk. I have a folding table near the fire exit." },
    ...
    /* 5  */ { type: 'text', speaker: 'The Intern', text: "It's a memo from the Regional Manager to Meredith. From THREE MONTHS AGO. Before she was supposedly 'assigned' to review us." },
  ...
  hr_rep_intro: [
    ...
    /* 4  */ { type: 'text', speaker: 'HR Representative', text: "Personnel files? Those are classified. And by 'classified' I mean I have personally sorted them into classes. A through F. Yours is... well." },
    /* 5  */ { type: 'end' },
  ...
  isaiah_recruit: [
    ...
    /* 2  */ { type: 'text', speaker: 'Isaiah', text: "I have nine years of receipts on Meredith. NINE." },
  ...
  diane_recruit: [
    /* 0  */ { type: 'text', speaker: 'Diane', text: "I've been documenting Meredith's policy violations since I started in HR." },
  ...
  team_chat_hub: [
    ...
    /* 2  */ { type: 'text', speaker: 'Janet', text: "I keep thinking about the Henderson account. Three generations of grandparents trusted us with that. The minute Meredith got the keys to this branch, she was looking for ways to liquidate it." },
    /* 3  */ { type: 'text', speaker: 'Janet', text: "I don't do speeches. But somebody in this building should keep a promise before the decade's out. Might as well be us." },
    /* 4  */ { type: 'text', speaker: 'Andrew', text: "I know. That's why I'm not done.", next: 0 },
    /* 5  */ { type: 'text', speaker: 'Alex from IT', text: "Hey. So I rolled the badge audit logs. Nine of the new hires didn't badge in through reception. Meredith issued them direct from the executive floor." },
    ...
    /* 10 */ { type: 'text', speaker: 'Isaiah', text: "I've worked here eleven years. I've watched seven boss types come through. Most of them just wanted the title. Meredith is the first one who wanted the building." },
    ...
    /* 95  */ { type: 'text', speaker: 'Diane', text: "Meredith isn't wrong that the department is inefficient. She's wrong about what that means. Inefficiency in trust work is sometimes just called — being thorough." },
  ...
  rachel_boss_combat: [
    ...
    /* 8  */ { type: 'text', speaker: 'Meredith Sterling', text: "You think a 77-year-old piece of paper is going to save your department? Paper only matters when it's denominated, Andrew." },
    /* 9  */ { type: 'text', speaker: 'Meredith Sterling', text: "I've spent fifteen years climbing the corporate ladder. I will NOT be stopped by a first-week trust officer and a JANITOR." },
  ...
  rachel_boss_defeated: [
    ...
    /* 10 */ { type: 'text', speaker: 'Andrew', text: "Apparently. I'd like to sit down now, if the building doesn't mind." },
    ...
    /* 13 */ { type: 'text', speaker: 'Skip Hartley', text: "That's the most beautiful thing I've ever heard. And I've read SEVEN leadership books this month." },
    ...
    /* 36 */ { type: 'text', speaker: 'Narrator', text: "Meredith's phone rang. She answered. Her face went white." },
    ...
    /* 38 */ { type: 'text', speaker: 'Meredith Sterling', text: "You... beat me by reading from a book." },
    /* 39 */ { type: 'text', speaker: 'Andrew', text: "It's not a book. It's the contract everyone in this building forgot they signed." },
    /* 40 */ { type: 'text', speaker: 'Narrator', text: "Meredith left without finishing her sentence. The Janitor was waiting in the hallway. He nodded at her once, the way you nod at the weather." },
    ...
    /* 50 */ { type: 'text', speaker: 'Narrator', text: "After Meredith leaves, the room is too quiet. Janet is the first one to put her tumbler down." },
    ...
    /* 60 */ { type: 'text', speaker: 'Narrator', text: "Meredith leaves. The team celebrates. You watch yourself watch them celebrate. There is a small, professional distance between you and the room that you do not entirely understand." },
  ...
  suggestion_box: [
    ...
    /* 3  */ { type: 'text', speaker: 'Narrator', text: "The most recent one is in Meredith's handwriting: 'Suggestion: eliminate the suggestion box. Optimize.'" },
    /* 4  */ { type: 'end' },
  ],
  ...
  board_charter: [
    ...
    /* 3  */ { type: 'text', speaker: 'Narrator', text: "The words shimmer slightly, in the manner of something that has been waiting since 1947 and is prepared to keep waiting." },
    /* 4  */ { type: 'end' },
  ],
  ...
  social_engineering_1: [
    ...
    /* 6  */ { type: 'text', speaker: 'Isaiah', text: "Talk to Diane about Meredith's assistant. She processes everyone who enters the building." },
    /* 7  */ { type: 'end' },
  ],
  ...
  ross_act6: [
    ...
    /* 3  */ { type: 'text', speaker: 'Skip Hartley', text: "Meredith wants to dissolve us. The board meets tomorrow at 4 PM. If we don't have a case, we're done." },
  ...
  janet_act6: [
    /* 0  */ { type: 'text', speaker: 'Janet', text: "I heard about the board meeting. Meredith's making her move." },
  ...
  diane_act6: [
    ...
    /* 1  */ { type: 'text', speaker: 'Diane', text: "That was the last straw. They took the actual straws too, so I'm being precise." },
  ...
  alex_it_act6: [
    /* 0  */ { type: 'text', speaker: 'Alex from IT', text: "The building is awake. I've suspected for months. It's a relief to stop pretending otherwise." },
  ...
  board_meeting: [
    // ── BLOCK A — ARRIVAL ───────────────────────────────────────────────
    /* 0  */ { type: 'text', speaker: 'Narrator', text: "The Board Room at 3:58 PM. Fourteen executive chairs, eleven of them occupied by people whose names appear on the building's tax filings. The twelfth belongs to a man who has not spoken in a board meeting since 1988. The other two are empty.", next: 178 },
    ...
    // D-JANET
    /* 49 */ { type: 'action', action: 'set_flag', flag: 'bm_janet_done', value: true, next: 180 },
    ...
    /* 53 */ { type: 'text', speaker: 'Narrator', text: "She did, in fact, bring a file drawer. It is sitting next to her chair. Several board members stare at it as though it might contain a bomb, which, in a way, it does.", next: 181 },
    // D-DIANE
    /* 54 */ { type: 'action', action: 'set_flag', flag: 'bm_diane_done', value: true, next: 182 },
    ...
    // D-ISAIAH
    /* 70 */ { type: 'action', action: 'set_flag', flag: 'bm_isaiah_done', value: true, next: 184 },
    ...
    /* 74 */ { type: 'text', speaker: 'Narrator', text: "Isaiah places a stack of highlighted documents on the table. It lands with the kind of weight that makes a board member move his water glass.", next: 185 },
    // D-PATTERN
    /* 75 */ { type: 'action', action: 'set_flag', flag: 'bm_pattern_done', value: true, next: 186 },
    ...
    /* 80 */ { type: 'text', speaker: 'Isaiah', text: "We're not walking.", next: 187 },
    // D-INTERN
    /* 81 */ { type: 'action', action: 'set_flag', flag: 'bm_intern_done', value: true, next: 188 },
    ...
    /* 86 */ { type: 'text', speaker: 'The Intern', text: "Sorry about the sound effects. I don't know how to turn them off.", next: 189 },
    // D-GRANDMA
    /* 87 */ { type: 'action', action: 'set_flag', flag: 'bm_grandma_done', value: true, next: 190 },
    ...
    /* 107 */ { type: 'text', speaker: 'Narrator', text: "Skip Hartley sits down. It is the first sincere sentence he has delivered in a conference room since 2003, and he looks like a man who has just set down something very heavy.", next: 192 },
    // E-BUZZ
    ...
    /* 111 */ { type: 'text', speaker: 'Narrator', text: "He sits down. The statement is airtight. It is also the loneliest sentence anyone has said in this room today.", next: 192 },
    // E-THIRD
    ...
    /* 153 */ { type: 'text', speaker: 'Narrator', text: "The room empties the way rooms do when no one wants to be the last to leave. Board members collect their phones, their pens, their untouched water glasses.", next: 193 },
    ...
    //    87/92/107/111/115/153/166) ═══════════════════════════════════════════
    // CLAUDE.md law: never insert into the middle — every jump above is an
    // absolute index. Stage nodes are APPENDED and routed into, and
    // `tools/_g-stage-verify.mjs` reads through them, so the tree is
    // structurally identical to the one before this block existed.
    //
    // GEOMETRY. The boardroom table blocks x 4-12 / z 4-6 and StageDirector
    // walks a STRAIGHT LINE with an axis slide, not a path. Every leg below was
    // simulated against the room's real built TileMap before it was written;
    // the two-leg crossings exist because the one-leg version scrapes the table
    // for five seconds and then times out into a teleport.
    //
    // NOT STAGED, deliberately: the Board Member's crossing at 124-127
    ...
    // is `wait: false` so it plays under the next line rather than holding the
    // conversation. Every ally returns to the exact tile room data put them on.
  ...
  ross_returned: [
    ...
    /* 3  */ { type: 'text', speaker: 'Skip Hartley', text: "The board is scrambling. The Algorithm is already running projections without him in the chain." },
    /* 4  */ { type: 'text', speaker: 'Skip Hartley', text: "That's what we're up against next. It doesn't have feelings. It doesn't have bad hair days. It just... optimizes." },
  ...
  ending_cooperative: [
    ...
    /* 4  */ { type: 'text', speaker: 'Skip Hartley', text: "I still can't believe the board went for it. I gave the most sincere speech of my career and didn't even use the word 'synergy' once." },
    ...
    /* 7  */ { type: 'text', speaker: 'Narrator', text: "Meredith was reassigned to a regional office in Fargo. Actual Fargo. She sends passive-aggressive holiday cards." },
    /* 8  */ { type: 'text', speaker: 'Isaiah', text: "Every client gets the Henderson Treatment now — full attention, full fiduciary duty. We named it after the hardest case we ever loved." },
  ...
  ending_compromise: [
    ...
    /* 1  */ { type: 'text', speaker: 'Narrator', text: "The board agrees to keep the department, but with 'enhanced oversight.' Meredith is reassigned, but her replacement is already being groomed." },
    /* 2  */ { type: 'text', speaker: 'Narrator', text: "One month later." },
    /* 3  */ { type: 'text', speaker: 'Skip Hartley', text: "We survived. Barely. The new oversight committee meets every Tuesday. It's like having a Compliance Auditor who never leaves." },
    /* 4  */ { type: 'text', speaker: 'Andrew', text: "At least we're still here. That counts for something." },
    /* 5  */ { type: 'text', speaker: 'Skip Hartley', text: "It counts for everything, Andrew. Even if 'everything' now includes mandatory quarterly synergy assessments." },
  ...
  ending_dissolution: [
    ...
    /* 3  */ { type: 'text', speaker: 'Skip Hartley', text: "They gave me a corner office in a building with no corners. I think it's a supply closet with delusions of grandeur." },
    ...
    /* 5  */ { type: 'text', speaker: 'Narrator', text: "The Intern got hired. By Meredith. He makes her coffee now. He says it's the worst paid job he's ever had, which is saying something." },
  ...
  janet_act7: [
    ...
    /* 2  */ { type: 'text', speaker: 'Janet', text: "And if the abstract objects, tell it Janet from the sixth floor is asking." },
    /* 3  */ { type: 'end' },
  ],
  ...
  isaiah_act7: [
    /* 0  */ { type: 'text', speaker: 'Isaiah', text: "I'll be in the board room with Skip. If you defeat The Algorithm, I'll present the evidence to the board." },
  ...
  penthouse_terminal: [
    ...
    /* 2  */ { type: 'text', speaker: 'Narrator', text: "The Algorithm files people under overhead. You, specifically, appear three times in the appendix." },
    /* 3  */ { type: 'end' },
  ],
  ...
  ending_architect: [
    ...
    /* 10 */ { type: 'text', speaker: 'The Janitor', text: "The building doesn't need a manager, Andrew. It needs someone who knows what the foundation is poured from. You've read page 47. You know." },
    ...
    /* 18 */ { type: 'text', speaker: 'Skip Hartley', text: "I don't know what happened up there, but every time I try to use the word 'synergy' in a meeting, my coffee goes cold. Like... instantly." },
  ...
  // what do you owe a pattern matcher that's done nothing wrong?
  // ==========================================================================
  ...
  intern_lunch_thief_confrontation: [
    ...
    /* 8  */ { type: 'text', speaker: 'The Intern', text: "...I'll go on my 'unpaid personal development period.' Which is what Skip calls my lunch break.", next: 11 },
  ...
  alex_printer_quest: [
    ...
    /* 8  */ { type: 'text', speaker: 'Alex from IT', text: "The toner runs out on purpose — I've checked the firmware. Someone modified it to abort any print job containing certain keywords." },
  ...
  alex_server_secret: [
    ...
    /* 11 */ { type: 'text', speaker: 'Alex from IT', text: "Skip? I... okay. He might escalate it. Or he might panic and do something that tips off whoever controls admin_legacy." },
    /* 12 */ { type: 'text', speaker: 'Alex from IT', text: "You know what — fine. Tell Skip. But be careful what you say. If the wrong people hear that we're onto this, my access gets revoked and the logs disappear." },
  ...
  isaiah_receipts_offer: [
    ...
    /* 5  */ { type: 'text', speaker: 'Isaiah', text: "If those records are still there, they would show a pattern. Not just this branch. Meredith's done this before. Other places. Other people." },
  ...
  diane_handbook_offer: [
    ...
    /* 6  */ { type: 'text', speaker: 'Diane', text: "Meredith had the original boxed up eighteen months ago. 'For archival.' I need to know if it's been destroyed or if it's still there." },
    ...
    /* 8  */ { type: 'text', speaker: 'Diane', text: "HR Records room. There should be a box labeled 'MISC ADMIN ARCHIVE' in the south filing section. That's how Meredith's people label things they want to disappear without destroying them. Plausible deniability." },
  ...
  diane_handbook_return: [
    ...
    /* 9  */ { type: 'text', speaker: 'Diane', text: "Edition stamp says 2019. The year Meredith arrived." },
  ...
  charter_challenge: [
    ...
    /* 4  */ { type: 'text', speaker: 'Narrator', text: "Your phone rings. It is Skip. You can hear him sweating." },
    /* 5  */ { type: 'text', speaker: 'Skip Hartley', text: "Andrew! Great. Fantastic. Small thing. Tiny thing. Meredith's old lawyers filed a challenge this morning — the charter's missing its Recorder's seal. Article 9. I'm looking at it right now. There's a... circle where a seal should be.", mood: 'worried' },
    ...
    // The Janitor speaks five lines here and had no body in the room. The
    // scene fires in `board_room` — the only room with a penthouse exit — from
    // `_changeRoom`'s uncertified-charter branch, and by then `act6_complete`
    // has derived `board_meeting_closed`, so every staging NPC is gone and the
    // room is empty. Same spawn pattern as the security guard and the Firm.
    // Not one word of prose is touched.
    /* 18 */ { type: 'stage', next: 8, beats: [
      // "A mop, somewhere behind you, stops mopping." — he is already there.
      { actor: 'janitor', spawn: true, spawnAt: 'aisle_n', face: 'player', hold: 0.35 },
      { actor: 'player',  face: 'janitor', wait: false },
    ] },
    // He leaves the way he does everything: without explaining. West along the
    // clear z=2 aisle (the table blocks x 4-12 / z 4-6 and the director walks
    // straight lines, not paths) and gone — ~3 s at 1.6, non-blocking so it
    // plays under the last line. A route all the way to the south door would be
    // three legs and twelve seconds of strolling after the scene has ended.
    /* 19 */ { type: 'stage', next: 17, beats: [
      { actor: 'janitor', exit: [1.5, 2], speed: 1.6, wait: false },
      { actor: 'player',  face: 'janitor', hold: 0.2 },
    ] },
  ],
  ...
  the_firm_ambush: [
    ...
    /* 11 */ { type: 'stage', next: 1, beats: [
      ...
      // And because that body EXISTS, `spawnAt` never applied to it —
      // `_resolveActor` returns the room's NPC and `_spawn` is never called —
      // so the leader started at his retry post (2,4) and walked TOWARD the
      // stairs while his two colleagues walked away from them. `teleportTo`
      // is the verb that makes an entrance work for a pre-placed actor.
      { actor: 'firm_partner',   spawn: true, show: true, spawnAt: 'stairs', teleportTo: 'stairs', walkTo: 'firm_a', face: 'player', speed: 1.9 },
