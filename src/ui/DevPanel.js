...
export const DEV_PRESETS = [
  ...
  },
  {
    ...
    flags: {
      ...
      skip_post_karen: true, chad_defeated: true, defeated_chad: true,
  ...
  },
  {
    ...
    flags: {
      ...
      skip_post_karen: true, chad_defeated: true, defeated_chad: true,
      grandma_defeated: true, defeated_grandma: true,
      defeated_compliance: true, defeated_regional: true, defeated_skip_boss: true,
      act2_complete: true,
    },
  },
  {
  ...
  },
  {
    ...
    flags: {
      ...
      has_archive_password: true, has_archive_evidence: true,
      act3_complete: true,
      met_janitor: true, janitor_rallied: true, skip_rallied: true, vault_accessible: true, hr_accessible: true, vault_code_1: true,
  ...
  },
  {
    ...
    flags: {
      ...
      meredith_fight_started: true, act5_complete: true,
      // `skip_speech_ready` is DERIVED from the skip_act6 scene, which this
  ...
  },
  {
    ...
    flags: {
      ...
      corporate_lawyer_defeated: true, board_room_accessible: true,
      meredith_fight_started: true, act5_complete: true,
      janet_rallied: true, diane_rallied: true, skip_rallied: true,
      ...
      // office (`act2_complete && !skip_speech_ready` vs `board_meeting_closed
      ...
      skip_speech_ready: true, act6_ready: true,
