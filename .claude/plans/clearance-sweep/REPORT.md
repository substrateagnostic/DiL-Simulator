...
**Non-player-facing but shipped-in-source (only if the repo is public):** .dlg comments naming Claude/Opus 4.6 as prose drafter (files 08, 09, 11, 13, 14, 15), style-anchor comments naming Bret Easton Ellis, Kent Haruf, Borges, a Mass Effect comment (05:804), and the "Stagecoach Stampede" comment (03:299, counted under H-1). The dialog compiler strips hash-comments from the shipped index.js; Vite minifies JS comments out of dist/.
...
2. **(Attorney)** Confirm whether the GitHub repo is public. If it is, decide whether the "Stagecoach Stampede" comment (03:299) and the style-anchor/author comments should be reworded (comments do not reach the built game).
